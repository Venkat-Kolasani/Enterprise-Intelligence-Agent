...
- [x] Gemini 3.1 Flash-Lite fallback is explicitly documented as development-only after the OpenAI account returned `insufficient_quota`.
...
- [ ] Charter and video accurately describe the verified provider; no Gemini output is labelled GPT-5.6.

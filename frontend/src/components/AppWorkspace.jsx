  ...
  return (
    <div className="workspace-shell">
      <header className="workspace-header">
        ...
        <div className="workspace-live"><span className={data.isRunning ? 'pulse-dot' : 'idle-dot'} aria-hidden="true" /> {data.isRunning ? 'Live decision feed' : 'Decision workspace'}</div>
      </header>
      ...
      <div className="workspace-frame">
        <aside className="workspace-sidebar">
          ...
          <div className="sidebar-footnote">
            ...
            <strong>SEEDED ENTERPRISE SCENARIO</strong>
            <p>Decision actions are saved to this shared workspace.</p>
          </div>
        </aside>
          ...
          <section className="view-heading">
            ...
            <div className="heading-actions">
              <button type="button" className="outline-action" onClick={data.startSimulation} disabled={data.isRunning || data.busy.simulation}>
                {data.isRunning ? 'Live feed running' : data.busy.simulation ? 'Starting…' : 'Start live feed'}
              </button>
            </div>
          </section>
